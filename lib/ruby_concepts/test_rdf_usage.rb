...
vc = RDFTypes::VirtualCollectionRDF.new('1123',"Test Title", "Test Description", "elr37")
...
<http://vivo.cornell.edu/individual/individual24416> a foaf:Person, foaf:Agent, prov:Entity .
...
<http://localhost:3000/individual/vc155> a co:List, prov:Entity ;
...
<http://localhost:3000/individual/act155> a prov:Activity ;
  prov:startedAtTime     "2011-07..." ;
  prov:wasAssociatedWith <http://vivo.cornell.edu/individual/individual24416> ;
  prov:used              <http://localhost:3000/individual/pe1> ;
  prov:endedAtTime       "2011-08..." .
